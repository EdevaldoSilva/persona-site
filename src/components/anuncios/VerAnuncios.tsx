...
const VerAnuncios = () => {
  return (
    <>
      ...
      <section className="mt-2 px-10"></section>
      ...
      <section className="mt-2 py-16 px-10">
        ...
        <div className="grid grid-cols-2 gap-8 align-middle">
          <div className="p-4 border rounded-lg shadow-md">
            <div className="mb-3">
              <h3 className="relative">
                Advogado para defender o Elliot
                <span className="text-sm font-normal absolute right-0">
                  Publicado a 10 horas
                </span>
              </h3>
            </div>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce
              convallis nunc urna, suscipit rhoncus tortor placerat a. In semper
              dolor id suscipit auctor. Nulla vitae venenatis sapien. Phasellus
              vestibulum dignissim viverra. Duis purus ligula, porta ac aliquam
              eu, rhoncus sed diam.
            </p>
            <Button
              color="white"
          ...
          <div className="p-4 border rounded-lg shadow-md">
            <div className="mb-3">
              <h3 className="relative">
                Pedreiro para fazer 1 quarto e sala
                <span className="text-sm font-normal absolute right-0">
                  Publicado a 10 horas
                </span>
              </h3>
